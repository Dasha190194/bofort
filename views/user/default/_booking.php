...
<div class="profile-container booking-container">
    ...
    <?php foreach ($orders as $order): ?>
        <?php if($order->state === 1 and $order->datetime_to < $date_now and $order->datetime_from < $date_now ): ?>
    ...
    <?php foreach ($orders as $order): ?>
        <?php if(($order->state === 1 and $order->datetime_to < $date_now and $order->datetime_from > $date_now ) or ($order->state === 2)): ?>
